		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zorderpurchasezorderpurchase-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zorderpurchasezorderpurchase-display": {
								"semanticObject": "zorderpurchasezorderpurchase",
								"action": "display",
								"description": "A Fiori application for Order Request.",
								"title": "Solicitudes de Pedido",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=gm.zorderpurchase",
									"url": sap.ui.require.toUrl("gm/zorderpurchase")
								}
							}
						}
					}
